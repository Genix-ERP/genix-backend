...
type CreateGRInput struct {
	...
	Lines           []CreateGRLineInput `json:"lines" binding:"required,min=1,dive"`
}
...
type CreateGRLineInput struct {
	...
	ReceivedQuantity float64 `json:"received_quantity" binding:"gte=0"`
...
type InspectGRInput struct {
	...
	Lines           []InspectGRLineInput `json:"lines" binding:"required,min=1,dive"`
}
